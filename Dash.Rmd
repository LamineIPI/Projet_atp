...
valueBox(nb_age, icon = "fa-birthday-cake", color= "lightgreen")
```
...
### Statistiques récapitulatives de `r  J_Prenom` `r  J_Nom` pour la saison `r  annee` (en %) {data-height=333}

```{r cars, cache=TRUE, fig.height=5, fig.width=6}
## Nb services
...
### Part de vitoires de `r  J_Prenom` `r  J_Nom` pour la saison `r  annee` par rapport au top 10 (en %) {data-height=333}
