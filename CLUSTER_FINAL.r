...
repr <- fviz_cluster(db, atp_non_remontada.scaled, geom = "point", main="représentation graphique du jeu de données avec les données abérrantes")
...
repr_ab <- fviz_cluster(db, atp_non_remontada.scaled_anomalie, geom = "point", main="représentation graphique sans les valeurs abérrantes")
...
# tx_err_bagging 
# # Taux d'erreur plus bas mais reste supérieur à 40% 
# 
...
# #0.4229249... pas folichon ça mais mieux
# 
# 
# #### Random Forest ####
# 
